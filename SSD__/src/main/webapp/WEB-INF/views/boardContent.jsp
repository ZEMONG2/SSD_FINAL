				...
				<div class="container">
					...
					<div class="panel panel-default">
						...
						<table class="table table-bordered table-hover">
							...
							<tr>
								<td
									style="height: 400px; text-align: center; vertical-align: middle">내용</td>
								<td>${fn:replace(vo.content, newLine,"<br>")}</td>
							</tr>
							<tr>
								<td colspan="2" align="center">
									<button class="btn btn-info btn-sm"
										onclick="location.href ='/boardUpdate.do/${vo.idx}'">수정</button>
									<button class="btn btn-warning btn-sm"
										onclick="location.href ='/boardDelete.do/${vo.idx}'">삭제</button>
									<button class="btn btn-success btn-sm"
										onclick="location.href ='/boardList'">리스트</button>
								</td>
							</tr>
						</table>
					</div>
					...
					<div class="row g-5">
						...
						<div class="col-lg-3 col-md-6">
							...
							<a class="btn btn-link text-white-50" href="/main">메인</a> <a
								...
								class="btn btn-link text-white-50" href="/boardList.do">공지사항</a>
						</div>
						<div class="col-lg-3 col-md-6">
